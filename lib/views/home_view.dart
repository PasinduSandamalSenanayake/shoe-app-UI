...
import '../models/box_content.dart';
import '../widgets/food_box.dart';
import 'food_detail_view.dart';

List<BoxContent> boxContent = [
  BoxContent(asset: "assets/nike1.png", color: Colors.orange),
  BoxContent(asset: "assets/nike2.png", color: Colors.greenAccent),
  BoxContent(asset: "assets/nike3.png", color: Colors.pinkAccent),
  BoxContent(asset: "assets/nike4.png", color: Colors.blueAccent),
  BoxContent(asset: "assets/nike5.png", color: Colors.lightGreenAccent),
          ...
          SizedBox(
            ...
            child: GestureDetector(
              onHorizontalDragEnd: (details) {
                // Swipe right
                // If the user swipes right, we want to move to the previous box
                // If the user swipes left, we want to move to the next box
